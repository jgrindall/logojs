...
LG.Config.PARSER_VISIT = "js/parser/visit.js";
...
LG.Messages.WRITE = "Click anywhere to draw";
...
LG.CanvasView = Backbone.View.extend({
	...
	process:function(tree){
		var _this = this;
		console.log("process", tree, LG.Config.PARSER_VISIT);
		this.working = true;
